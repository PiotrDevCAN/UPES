...
function __construct($tableName=null, $pwd=null){
	...
	$firstDate->setISODate ( "2019", "01", 5 );
...
// 	$this->sql = str_replace('SELECT ,','SELECT ',$this->sql);
	...
	$this->sql = " SELECT decrypt_char(log_entry,'jwMfgY02fZSuXA9tmU8u') as log_entry, class, method, page, elapsed ";
	$this->sql.= " FROM " . $_SESSION['Db2Schema'] . "." . AllItdqTables::$TRACE . " as E ";
