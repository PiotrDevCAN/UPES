...
$slack->sendMessageToChannel("Revalidation will ignore " . count($allOffboarders) . " offboarding/ed.", slack::CHANNEL_UPES_AUDIT);
...
$slack->sendMessageToChannel("Revalidation will ignore " . count($allPreboarders) . " pre-boarders.", slack::CHANNEL_UPES_AUDIT);
...
$slack->sendMessageToChannel("Revalidation will ignore " . count($allVendors) . " vendors.", slack::CHANNEL_UPES_AUDIT);
