...
$sql = " SELECT '' AS ACTION, P.EMAIL_ADDRESS, P.FULL_NAME, A.ACCOUNT, PL.PES_LEVEL, PL.PES_LEVEL_DESCRIPTION, AP.PES_STATUS,AP.PES_CLEARED_DATE, AP.ACCOUNT_ID, AP.UPES_REF, AP.PES_REQUESTOR, AP.PES_DATE_REQUESTED ";
