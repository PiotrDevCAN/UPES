...
<p><b>The Certification MUST be done by a Kynryl/IBM'er<b>, to confirm that they have seen the original document. Either physically or Virtually (over webex).<p> For Virtual - an email can be sent directly to the PES team, by your certifier <b>to confirm each original documents/screens (in a list) which have been viewed, over video conferencing, along with the date and time they were viewed.<b> OR Physical - The following statement should be added on each document, on the same side as the image.</p>
