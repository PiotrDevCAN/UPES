...
$pesEmail.= '<p>Please remember if you have sent your documents without certification you can only be provisionally cleared and not receive full PES clearance, so if you can get them certified correctly (ie your manager viewing the original document/s and signing) please do so.</p>';
