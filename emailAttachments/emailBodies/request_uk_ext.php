...
<p><p><b>The Certification MUST be done by an IBM'er<b>, to confirm that they have seen the original document. Either physically by another IBM’er or Virtually (over webex) by your IBM Manager.<p> For Physical - The following statement should be added on each document, on the same side as the image.</p>
