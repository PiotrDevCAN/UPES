...
class PersonRecord extends DbRecord
{
    ...
    function displayForm($mode)
    {
        ...
        ?>
        <form id='peopleForm' class="form-horizontal" method='post'>
