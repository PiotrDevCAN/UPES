...
class Helper {
	...
	// checkIfRfsIdExists(newRfsId) {
	// 	var allreadyExists = ($.inArray(newRfsId, window.knownRfs) >= 0);
	// 	return allreadyExists;
	// }

	// addRfsIdToKnown(newRfsId) {
	// 	if (typeof (window.knownRfs) !== 'undefined') {
	// 		window.knownRfs.push(newRfsId);
	// 	}
	// }

	// getRfsId(el) {
	// 	var rfsId = $(el).val().trim();
	// 	return rfsId;
	// }
